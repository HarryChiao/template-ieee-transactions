...
\subsubsection{Bandwidth set to 50 Mbps}
We set the bandwidth of every link in our topology to 50 Mbps. Due to the multi-to-one flow scenario, the shared link is the bottleneck for all flows.

\subsubsection{Bandwidth set to 80 Mbps}

\subsubsection{Bandwidth set to 100 Mbps}
